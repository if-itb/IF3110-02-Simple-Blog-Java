...
public class load_comments extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String sqlStr = "SELECT * FROM komentar WHERE id_post='"+id_post+"' ORDER BY tanggal DESC";
            ...
            while (rset.next()) {
                ...
                listofcomments = listofcomments + "<a href=\"#\">"+rset.getString("nama")+"</a></h2>";
                listofcomments = listofcomments + "<div class=\"art-list-time\">"+rset.getString("tanggal")+"</div></div><p>"+rset.getString("komentar")+"</p></li>";
            }
