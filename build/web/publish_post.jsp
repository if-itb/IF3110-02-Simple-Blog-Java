...
<%
  ...
  try {
    ...
    rs = stmt.executeQuery("SELECT * FROM post WHERE status='unpublished' ORDER BY post_date DESC ");
%>
<div class="wrapper">
        ...
        <nav class="art-list">
          <ul class="art-list-body">
            ...
            <li class="art-list-item">
                ...
                <p>
                    <f:subview id="asd" rendered="#{loginHandler.login}"><a href="update_post.jsp?postId=<% out.print(rs.getString("post_id")); %>">Edit</a> | <a href="delete_post.jsp?postId=<% out.print(rs.getString("post_id")); %>"">Hapus</a> | <a href="publishServlet?postId=<% out.print(rs.getString("post_id")); %>"">Publish</a>
                    </f:subview>
                </p>
            </li>
            <%}}
