...
<nav class="nav">
    <a style="border:none;" id="logo" href="home-owner.jsp"><h1>Simple<span>-</span>Blog</h1></a>
...
<div id="home">
    <div class="posts">
		...
		try 
		{
                    String sql=("SELECT * FROM post,user WHERE post.user_id=user.user_id AND status_publish=1");
