...
public class UserController implements Serializable {
    ...
    public void addUser(User user) {
        ...
        try {
            ...
            if (getUserByUsername(user.getUsername()) != null) {
                ...
                dbController.executeUpdate("INSERT INTO `user` "
            ...
            context.addMessage("_add-user-form:_username", 
                    new FacesMessage("Terjadi kesalahan pada basis data: " 
                            + e.getMessage()));
        }
    }
    ...
    public void modifyUser(int id, String username, String password, 
        ...
        User _dummy = new User(username, password, email, role);
    ...
    public void modifyUser(User user) throws IOException {
        ...
        try {
            ...
            ResultSet result = dbController.executeQuery("SELECT * FROM `user` "
                    ...
                    new String[]{user.getUsername(), Integer.toString(user.getId())});
            User other = null;
            while (result.next()) {
            ...
            if (other != null) {
                ...
                dbController.executeUpdate("UPDATE `user` SET "
                        + "`username` = ?, `password` = ?, `email` = ?, `role` = ? "
                        + "WHERE `id` = ?",
                        new String[]{user.getUsername(), user.getPassword(), 
                            user.getEmail(), user.getRole(), Integer.toString(user.getId())});
