...
public class Posts {
    ...
    public ArrayList<Post> getPublishedPost() {
        ...
        try {
            resultSet = databaseAccess.selectAllRecords("post", "Published=TRUE AND Deleted=FALSE");
            }
            catch (SQLException e1) {
			System.out.println(e1);
            }
    ...
    public ArrayList<Post> getDeletedPost(boolean deleted) {
        ...
        try {
            if (deleted){
                resultSet = databaseAccess.selectAllRecords("post", "Deleted=TRUE");
            }
            else {
                resultSet = databaseAccess.selectAllRecords("post", "Deleted=FALSE");
            }
        }
        catch (SQLException e1) {
            System.out.println(e1);
